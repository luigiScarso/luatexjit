...
static const char _svn_version[] =
    "$Id: luainit.w 4479 2012-11-07 16:38:55Z taco $"
...
void lua_initialize(int ac, char **av)
{
    ...
    if (luatex_svn < 0) {
        const char *fmt = "This is LuaTeXJIT, Version %s-%s" WEB2CVERSION;
        size_t len;
        char buf[16];
        ...
        const char *fmt = "This is LuaTeXJIT, Version %s-%s " WEB2CVERSION "(rev %d)";
        size_t len;
        char buf[16];
        sprintf(buf, "%d", luatex_date_info);
